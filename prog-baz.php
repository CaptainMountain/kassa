...
<form name="calc" action="" method="POST">
	...
	<br><br>
		<div id="changeview">
			<div id="tagname">&nbspПРОГРАММИРОВ. БАЗ</div>
		</div> 
	<br><br><br><br>
	</div>
	...
	<div class="btns">
		...
		<input type="button" name="add" value="+" style="background: #818790;" onclick="location.href='index.php'">
		<input type="button" id="minus" name="sub" value="-"style="background: #818790;"onclick="location.href='prog.php'">
